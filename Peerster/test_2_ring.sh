...
./client/client -UIPort=12349 -msg=$message_c1_1 -file=caca
./client/client -UIPort=12346 -msg=$message_c2_1 -file=caca
sleep 2
./client/client -UIPort=12349 -msg=$message_c1_2 -file=caca
sleep 1
./client/client -UIPort=12346 -msg=$message_c2_2 -file=caca
./client/client -UIPort=12351 -msg=$message_c3 -file=caca
